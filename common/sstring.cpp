...
/*===========================================================================
 *
 * Function - CSStringArray SplitString (Buffer, SplitChar);
 *
 *=========================================================================*/
CSStringArray SplitString(const CSString& Buffer, const char SplitChar)
{
	...
	if (Buffer.IsEmpty()) return SplitStrings;

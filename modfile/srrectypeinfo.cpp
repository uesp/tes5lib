...
{
	{ SR_NAME_AACT, "Aact",      SRCLASS_CSrAactRecord, CSrAactRecord::s_FieldMap, CSrAactRecord::Create },
	...
	{ SR_NAME_ADDN, "Addn",      SRCLASS_CSrAddnRecord, CSrAddnRecord::s_FieldMap, CSrAddnRecord::Create },
	...
	{ SR_NAME_ANIO, "Anio",      SRCLASS_CSrAnioRecord, CSrAnioRecord::s_FieldMap, CSrAnioRecord::Create },
	...
	{ SR_NAME_ARTO, "Arto",      SRCLASS_CSrArtoRecord, CSrArtoRecord::s_FieldMap, CSrArtoRecord::Create },
	{ SR_NAME_ASPC, "Aspc",      SRCLASS_CSrAspcRecord, CSrAspcRecord::s_FieldMap, CSrAspcRecord::Create },
	{ SR_NAME_ASTP, "Astp",      SRCLASS_CSrAstpRecord, CSrAstpRecord::s_FieldMap, CSrAstpRecord::Create },
	{ SR_NAME_AVIF, "Avif",      SRCLASS_CSrAvifRecord, CSrAvifRecord::s_FieldMap, CSrAvifRecord::Create },
	{ SR_NAME_BOOK, "Book",      SRCLASS_CSrBookRecord, CSrBookRecord::s_FieldMap, CSrBookRecord::Create },
	{ SR_NAME_BPTD, "Bptd",      SRCLASS_CSrBptdRecord, CSrBptdRecord::s_FieldMap, CSrBptdRecord::Create },
	{ SR_NAME_CAMS, "Cams",      SRCLASS_CSrCamsRecord, CSrCamsRecord::s_FieldMap, CSrCamsRecord::Create },
	...
	{ SR_NAME_CLFM, "Clfm",      SRCLASS_CSrClfmRecord, CSrClfmRecord::s_FieldMap, CSrClfmRecord::Create },
	{ SR_NAME_CLMT, "Clmt",      SRCLASS_CSrClmtRecord, CSrClmtRecord::s_FieldMap, CSrClmtRecord::Create },
	{ SR_NAME_COBJ, "Recipe",      SRCLASS_CSrCobjRecord, CSrCobjRecord::s_FieldMap, CSrCobjRecord::Create },
	{ SR_NAME_COLL, "Coll",      SRCLASS_CSrCollRecord, CSrCollRecord::s_FieldMap, CSrCollRecord::Create },
	{ SR_NAME_CONT, "Container",      SRCLASS_CSrContRecord, CSrContRecord::s_FieldMap, CSrContRecord::Create },
	{ SR_NAME_CPTH, "Cpth",      SRCLASS_CSrCpthRecord, CSrCpthRecord::s_FieldMap, CSrCpthRecord::Create },
	{ SR_NAME_CSTY, "Csty",      SRCLASS_CSrCstyRecord, CSrCstyRecord::s_FieldMap, CSrCstyRecord::Create },
	{ SR_NAME_DEBR, "Debr",      SRCLASS_CSrDebrRecord, CSrDebrRecord::s_FieldMap, CSrDebrRecord::Create },
	{ SR_NAME_DIAL, "DialogTopic",      SRCLASS_CSrDialRecord, CSrDialRecord::s_FieldMap, CSrDialRecord::Create },
	{ SR_NAME_DLBR, "Dlbr",      SRCLASS_CSrDlbrRecord, CSrDlbrRecord::s_FieldMap, CSrDlbrRecord::Create },
	{ SR_NAME_DLVW, "Dlvw",      SRCLASS_CSrDlvwRecord, CSrDlvwRecord::s_FieldMap, CSrDlvwRecord::Create },
	{ SR_NAME_DOBJ, "Dobj",      SRCLASS_CSrDobjRecord, CSrDobjRecord::s_FieldMap, CSrDobjRecord::Create },
	{ SR_NAME_DOOR, "Door",      SRCLASS_CSrDoorRecord, CSrDoorRecord::s_FieldMap, CSrDoorRecord::Create },
	{ SR_NAME_DUAL, "Dual",      SRCLASS_CSrDualRecord, CSrDualRecord::s_FieldMap, CSrDualRecord::Create },
	{ SR_NAME_ECZN, "Eczn",      SRCLASS_CSrEcznRecord, CSrEcznRecord::s_FieldMap, CSrEcznRecord::Create },
	{ SR_NAME_EFSH, "Efsh",      SRCLASS_CSrEfshRecord, CSrEfshRecord::s_FieldMap, CSrEfshRecord::Create },
	{ SR_NAME_ENCH, "Enchantment",      SRCLASS_CSrEnchRecord, CSrEnchRecord::s_FieldMap, CSrEnchRecord::Create },
	{ SR_NAME_EQUP, "Equp",      SRCLASS_CSrEqupRecord, CSrEqupRecord::s_FieldMap, CSrEqupRecord::Create },
	...
	{ SR_NAME_FSTP, "Fstp",      SRCLASS_CSrFstpRecord, CSrFstpRecord::s_FieldMap, CSrFstpRecord::Create },
	{ SR_NAME_FSTS, "Fsts",      SRCLASS_CSrFstsRecord, CSrFstsRecord::s_FieldMap, CSrFstsRecord::Create },
	...
	{ SR_NAME_IDLM, "Idlm",      SRCLASS_CSrIdlmRecord, CSrIdlmRecord::s_FieldMap, CSrIdlmRecord::Create },
	{ SR_NAME_IMAD, "Imad",      SRCLASS_CSrImadRecord, CSrImadRecord::s_FieldMap, CSrImadRecord::Create },
	{ SR_NAME_IMGS, "Imgs",      SRCLASS_CSrImgsRecord, CSrImgsRecord::s_FieldMap, CSrImgsRecord::Create },
	...
	{ SR_NAME_IPCT, "Ipct",      SRCLASS_CSrIpctRecord, CSrIpctRecord::s_FieldMap, CSrIpctRecord::Create },
	{ SR_NAME_IPDS, "Ipds",      SRCLASS_CSrIpdsRecord, CSrIpdsRecord::s_FieldMap, CSrIpdsRecord::Create },
	...
	{ SR_NAME_LCRT, "Lcrt",      SRCLASS_CSrLcrtRecord, CSrLcrtRecord::s_FieldMap, CSrLcrtRecord::Create },
	{ SR_NAME_LCTN, "Lctn",      SRCLASS_CSrLctnRecord, CSrLctnRecord::s_FieldMap, CSrLctnRecord::Create },
	{ SR_NAME_LGTM, "Lgtm",      SRCLASS_CSrLgtmRecord, CSrLgtmRecord::s_FieldMap, CSrLgtmRecord::Create },
	{ SR_NAME_LIGH, "Light",      SRCLASS_CSrLighRecord, CSrLighRecord::s_FieldMap, CSrLighRecord::Create },
	{ SR_NAME_LSCR, "Lscr",      SRCLASS_CSrLscrRecord, CSrLscrRecord::s_FieldMap, CSrLscrRecord::Create },
	...
	{ SR_NAME_MATO, "Mato",      SRCLASS_CSrMatoRecord, CSrMatoRecord::s_FieldMap, CSrMatoRecord::Create },
	{ SR_NAME_MATT, "Matt",      SRCLASS_CSrMattRecord, CSrMattRecord::s_FieldMap, CSrMattRecord::Create },
	...
	{ SR_NAME_MOVT, "Movt",      SRCLASS_CSrMovtRecord, CSrMovtRecord::s_FieldMap, CSrMovtRecord::Create },
	{ SR_NAME_MSTT, "Mstt",      SRCLASS_CSrMsttRecord, CSrMsttRecord::s_FieldMap, CSrMsttRecord::Create },
	{ SR_NAME_MUSC, "Muscic",      SRCLASS_CSrMuscRecord, CSrMuscRecord::s_FieldMap, CSrMuscRecord::Create },
	{ SR_NAME_MUST, "MusicTrack",      SRCLASS_CSrMustRecord, CSrMustRecord::s_FieldMap, CSrMustRecord::Create },
	{ SR_NAME_NAVI, "Navi",      SRCLASS_CSrNaviRecord, CSrNaviRecord::s_FieldMap, CSrNaviRecord::Create },
	{ SR_NAME_NAVM, "Navm",      SRCLASS_CSrNavmRecord, CSrNavmRecord::s_FieldMap, CSrNavmRecord::Create },
	...
	{ SR_NAME_PGRE, "Pgre",      SRCLASS_CSrPgreRecord, CSrPgreRecord::s_FieldMap, CSrPgreRecord::Create },
	{ SR_NAME_PHZD, "Phzd",      SRCLASS_CSrPhzdRecord, CSrPhzdRecord::s_FieldMap, CSrPhzdRecord::Create },
	...
	{ SR_NAME_REVB, "Revb",      SRCLASS_CSrRevbRecord, CSrRevbRecord::s_FieldMap, CSrRevbRecord::Create },
	{ SR_NAME_RFCT, "Rfct",      SRCLASS_CSrRfctRecord, CSrRfctRecord::s_FieldMap, CSrRfctRecord::Create },
	...
	{ SR_NAME_SMBN, "Smbn",      SRCLASS_CSrSmbnRecord, CSrSmbnRecord::s_FieldMap, CSrSmbnRecord::Create },
	{ SR_NAME_SMEN, "Smen",      SRCLASS_CSrSmenRecord, CSrSmenRecord::s_FieldMap, CSrSmenRecord::Create },
	{ SR_NAME_SMQN, "Smqn",      SRCLASS_CSrSmqnRecord, CSrSmqnRecord::s_FieldMap, CSrSmqnRecord::Create },
	{ SR_NAME_SNCT, "Snct",      SRCLASS_CSrSnctRecord, CSrSnctRecord::s_FieldMap, CSrSnctRecord::Create },
	{ SR_NAME_SNDR, "Sndr",      SRCLASS_CSrSndrRecord, CSrSndrRecord::s_FieldMap, CSrSndrRecord::Create },
	{ SR_NAME_SOPM, "Sopm",      SRCLASS_CSrSopmRecord, CSrSopmRecord::s_FieldMap, CSrSopmRecord::Create },
	...
	{ SR_NAME_SPGD, "Spgd",			SRCLASS_CSrSpgdRecord, CSrSpgdRecord::s_FieldMap, CSrSpgdRecord::Create },
	{ SR_NAME_STAT, "Static",		SRCLASS_CSrStatRecord, CSrStatRecord::s_FieldMap, CSrStatRecord::Create },
	{ SR_NAME_TACT, "Tact",			SRCLASS_CSrTactRecord, CSrTactRecord::s_FieldMap, CSrTactRecord::Create },
	...
	{ SR_NAME_TXST, "Txst",			SRCLASS_CSrTxstRecord, CSrTxstRecord::s_FieldMap, CSrTxstRecord::Create },
